...
creditCardRouter.patch("/setDefaultCard/:cardId", authentication_1.Authentication, (0, validation_1.Validation)(CV.setDefaultCardSchema), card_service_1.default.setDefaultCard);
creditCardRouter.delete("/deleteCard/:cardId", authentication_1.Authentication, (0, validation_1.Validation)(CV.delCardSchema), card_service_1.default.deleteCard);
